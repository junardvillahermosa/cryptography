...
function encrypt(msg, key, numSteps) {
    ...
    /* Step 3 */
    if(step++ == numSteps) return html;
    html += '<div style="background-color: skyblue;margin-top:20px; padding: 20px 40px; border-radius: 20px; width: 100%;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #022B54; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 3:</span> <br><br>Rotating each half</h3>Split the key in half, then left rotate each bit according to the table:<br><br>';
    ...
    /* Step 4 */
    if(step++ == numSteps) return html;
    html += '<div style="background-color: skyblue; padding: 20px 40px; border-radius: 20px; width: 100%;margin-top:20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #022B54; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 4:</span> <br><br>Concatenation</h3><br>';
    ...
    /* Step 5 */
    if(step++ == numSteps) return html;
    html += '<div style="background-color: skyblue; padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #022B54; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 5:</span> <br><br>Permute the key through the PC-2 table</h3><br>';
    ...
    /* Step 6 */
    if(step++ == numSteps) return html;
    html += '<div style="background-color: skyblue; padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #022B54; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 6:</span><br><br> Permute the message through IP</h3><br>';
    ...
    /* Step 7 */
    if(step++ == numSteps) return html;
    html += '<div style="background-color: skyblue; padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #022B54; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 7:</span><br><br> Encode the data</h3><br>';
    ...
    for(let i = 0; i < 16; i++) {
        ...
        /* Step 8 */
        if(step++ == numSteps) return html;
        html += '<div style="background-color: skyblue; padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #022B54; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step ' + step + ':</span> <br><br>Computing ROUND ' + (i + 1) + '</h3>';
    ...
    /* Step 24 */
    if(step++ == numSteps) return html;
    html += '<div style="background-color: skyblue; padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #022B54; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 24:</span> <br><br>Permute the encoded data through the IP<sup>-1</sup> table</h3><br>';
    ...
    /* Step 25 */
    if(step++ == numSteps) return html;
    html += '<div style="background-color: skyblue; padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #022B54; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 25:</span> <br><br>Convert back into hexadecimal</h3><br><br>';
